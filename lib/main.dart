...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: MyHomePage(title: 'Flutter Hello App Demo'),
    );
  }
}
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    var imageWidget3 = Image(
      image: AssetImage("images2/test_only_main_asset_2.png", package: "flutter_hello_app"),
      width: 100,
      height: 100,
    );
